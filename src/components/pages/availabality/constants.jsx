...
export const availability = {
    ...
    buttons: {
        ...
        "l06": {
            lvl: 6, isActive: false},
        "l07": {
            lvl: 7, isActive: false},
        "l08": {
            lvl: 8, isActive: false},
        "l09": {
            lvl: 9, isActive: true},
        "l10": {
            lvl: 10, isActive: false},
        "l11": {
            lvl: 11, isActive: false},
        "l12": {
            lvl: 12, isActive: false},
        "l13": {
            lvl: 13, isActive: false},
        "l14": {
            lvl: 14, isActive: true},
        "l15": {
            lvl: 15, isActive: false},
        "l16": {
            lvl: 16, isActive: false},
        "l17": {
            lvl: 17, isActive: false},
        "l18": {
            lvl: 18, isActive: true},
        "l19": {
            lvl: 19, isActive: true},
        "l20": {
            lvl: 20, isActive: true},
        "l21": {lvl: 21, isActive: false},
        "l22": {lvl: 22, isActive: true},
        "l25": {lvl: 25, isActive: false},
        "l26": {lvl: 26, isActive: false},
        "l27": {lvl: 27, isActive: false},
        "l28": {lvl: 28, isActive: false},
    ...
    assets: {
        ...
        lvlVectors: {
            l14: {
                vector: {
                    key: "l14-vector",
                    src: imageCDN("availability","Availability-Vector-L14", "svg"),
                    role: "presentation",
                    width: 491,
                    height: 54,
                    positionTop: 82,
